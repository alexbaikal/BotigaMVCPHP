...
*/
    ...
    function mostrarProductos()
    {
        ...
        echo "<div id='divlupa' style='display: flex; justify-content: center; margin-bottom: 20px; align-items:center;'>";
        echo "<form action='adminCourses.php' method='GET' id='formlupa'>";
        echo "<input id='buscador' type='text' name='search' placeholder='Cerca per nom del curs o DNI'>";
        echo "<input id='lupa' type='submit' value='🔎'>";
        echo "</form>";
        echo "</div>";
